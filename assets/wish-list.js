    ...
    debugger;
      ...
      $.ajax({
        ...
        success: function(data) { 
          form.html('<a class="wish" href="/pages/wishlist" title="Go to Wishlist" ><i class="icon icon-check"></i></a>');
        },
  ...
  function initProductWishlist() {
    ...
    debugger;
      ...
      $.ajax({
        ...
        success: function(data) {
          hidePopup('.loading');  
          productItem.html('<a class="link-ver1 wish" href="/pages/wishlist" title="Go to Wishlist" ><i class="fa fa-check"></i></a>'); 
        },
        error: function(xhr, text) {
          hidePopup('.loading');    
          $('.error-message').text($.parseJSON(xhr.responseText).description);
